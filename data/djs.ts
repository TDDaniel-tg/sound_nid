...
export const djs: DJ[] = [
  ...
  },
  {
    id: "tigrulya",
    name: "DMC TIGRULYA",
    image: "/telegram_assets/dmc_tigrulya.jpeg",
    tags: ["MC / DJ", "Свадьбы", "Клубы"],
    experience: "Исси и Бисси, Гейша, Дорогая я перезвоню, Зелёная собака, Zall, Nebar, Zavisimost 360, Papa's, Busters, Руки Вверх, White Star, Stone Club",
    description: "Master of Ceremonies / DJ. Полный мультиформат — подстраивается под формат заведения и чувствует публику. Проводит порядка 30 свадеб в сезон как ведущий и более 50 свадеб как диджей. Пунктуален, вежлив, всегда на позитиве.",
  },
];
